...
\node [draw, circle, fill=red] (v1) at (0,0) {};
\node [draw, circle, fill=black] (v2) at (1,0) {};
\node [draw, circle, fill=vert] (v3) at (2,0) {};
\node [draw, circle, fill=black] (v4) at (3,0) {};
\node [draw, circle, fill=vert] (v5) at (4,0) {};
\node [draw, circle, fill=black] (v6) at (5,0) {};
\node [draw, circle, fill=vert] (v7) at (6,0) {};
\node [draw, circle, fill=vert] (v8) at (3,-1) {};
...
\node [draw, circle, fill=vert] (v11) at (5,-1) {};
\draw  (v1) edge (v2);
\draw  (v2) edge (v3);
\draw  (v3) edge (v4);
\draw  (v4) edge (v5);
